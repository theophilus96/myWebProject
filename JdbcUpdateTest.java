   ...
   public static void main(String[] args) {
      try (
         ...
         Connection conn = DriverManager.getConnection(
               "jdbc:mysql://localhost:3306/ebookshop?allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=UTC", "myuser", "Fingo96@"); // MySQL
...
//java -cp .:$HOME/documents/myWebProject/mysql-connector-java-8.0.15/mysql-connector-java-8.0.15.jar JdbcUpdateTest
//java -cp .:$HOME/myWebProject/mysql-connector-java-8.0.15/mysql-connector-java-8.0.15.jar JdbcUpdateTest
//javac JdbcUpdateTest.java
